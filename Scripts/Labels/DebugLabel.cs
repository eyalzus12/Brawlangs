...
public class DebugLabel : InfoLabel
{
	...
	public override void UpdateLabel()
	{
		...
		Add("Up", ch.upHeld);
		Newline();
		Add("MaxAirJumps", ch.maxAirJumpsAllowed);
		Add("AirJumpsUsed", ch.currentAirJumpsUsed);
		Add("AirJumpsOnHitting", ch.givenAirJumpsOnHitting);
		Add("AirJumpsOnGettingHit", ch.givenAirJumpsOnGettingHit);
		Newline();
		Add("MaxClings", ch.maxClingsAllowed);
		Add("ClingsUsed", ch.currentClingsUsed);
		Add("ClingsOnHitting", ch.givenClingsOnHitting);
		Add("ClingsOnGettingHit", ch.givenClingsOnGettingHit);
		Newline();
